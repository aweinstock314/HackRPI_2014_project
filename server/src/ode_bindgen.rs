#![allow(dead_code, non_camel_case_types, non_upper_case_globals, non_snake_case)] // disable warnings for the auto-generated C bindings
extern crate libc;
...
impl Union_wait {
    ...
    pub fn __wait_terminated(&mut self) -> *mut Struct_Unnamed6 {
        unsafe { ::std::mem::transmute(self) }
    }
    pub fn __wait_stopped(&mut self) -> *mut Struct_Unnamed7 {
        unsafe { ::std::mem::transmute(self) }
    }
}
#[repr(C)]
...
impl Union_Unnamed17 {
    pub fn __data(&mut self) -> *mut Struct_Unnamed18 {
        unsafe { ::std::mem::transmute(self) }
    }
...
impl Union_Unnamed20 {
    pub fn __data(&mut self) -> *mut Struct_Unnamed21 {
        unsafe { ::std::mem::transmute(self) }
    }
    pub fn __size(&mut self) -> *mut [libc::c_char, ..56u] {
        unsafe { ::std::mem::transmute(self) }
...
pub type dMessageFunction = libc::c_void;
pub type dReal = libc::c_float;
pub type dTriIndex = uint32;
pub type dVector3 = [dReal, ..4u];
pub type dVector4 = [dReal, ..4u];
pub type dMatrix3 = [dReal, ..12u];
pub type dMatrix4 = [dReal, ..16u];
pub type dMatrix6 = [dReal, ..48u];
pub type dQuaternion = [dReal, ..4u];
...
pub const dAllocateMaskAll: libc::c_uint = -1;
...
pub type dAllocFunction = libc::c_void;
pub type dReallocFunction = libc::c_void;
pub type dFreeFunction = libc::c_void;
#[repr(C)]
pub struct Struct_dStopwatch {
    pub time: libc::c_double,
    pub cc: [libc::c_ulong, ..2u],
}
...
pub type dNearCallback = libc::c_void;
...
pub type dTriCallback = libc::c_void;
pub type dTriArrayCallback = libc::c_void;
pub type dTriRayCallback = libc::c_void;
pub type dTriTriMergeCallback = libc::c_void;
pub enum Struct_dxHeightfieldData { }
pub type dHeightfieldDataID = *mut Struct_dxHeightfieldData;
pub type dHeightfieldGetHeight = libc::c_void;
pub type dGetAABBFn = libc::c_void;
pub type dColliderFn = libc::c_void;
pub type dGetColliderFnFn = libc::c_void;
pub type dGeomDtorFn = libc::c_void;
pub type dAABBTestFn = libc::c_void;
#[repr(C)]
pub struct Struct_dGeomClass {
    ...
    pub aabb_test: *mut ::std::option::Option<extern "C" fn
                                                  (arg1: dGeomID,
                                                   ...
                                                   arg3: [dReal, ..6u])
                                                  -> libc::c_int>,
    pub dtor: *mut ::std::option::Option<extern "C" fn(arg1: dGeomID)>,
}
...
extern "C" {
     ...
     *mut ::std::option::Option<extern "C" fn(arg1: size_t)
                                    -> *mut libc::c_void>;
    ...
    pub fn dDQfromW(dq: [dReal, ..4u], w: dVector3, q: dQuaternion);
    ...
    pub fn dGeomGetAABB(geom: dGeomID, aabb: [dReal, ..6u]);
     ...
     *mut ::std::option::Option<extern "C" fn
                                    (arg1: dGeomID, arg2: dGeomID,
                                     arg3: libc::c_int, arg4: dReal,
                                     arg5: dReal) -> libc::c_int>;
    ...
    pub fn dInfiniteAABB(geom: dGeomID, aabb: [dReal, ..6u]);
